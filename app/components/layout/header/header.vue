...
<template>
  <nav :class="[
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
      <div class="flex justify-between items-center h-24"> <div class="flex items-center">
          <NuxtLink to="/" class="flex items-center group">
            ...
            <div class="ml-2 flex flex-col justify-center">
              <span :class="[
                ...
                isScrolled ? 'text-3xl text-[#F2C46D]' : 'text-4xl text-[#F2C46D]'
              ]">Experienzzia</span>
              <span class="text-[11px] font-sans font-bold text-[#F2F2F2] tracking-[0.2em] uppercase">Gourmet</span>
            </div>
          </NuxtLink>
        </div>
        ...
        <div class="hidden md:flex items-center space-x-10">
          ...
          <a href="https://wa.me/57XXXXXXXXXX" target="_blank"
            class="bg-[#24735C] hover:bg-[#F2C46D] text-[#F2F2F2] hover:text-[#1D5948] px-8 py-3 font-sans text-xs font-bold uppercase tracking-widest transition-all duration-300 rounded-full shadow-lg border border-[#F2C46D]/30">
            Pide a Domicilio
          </a>
        </div>
    ...
    <Transition name="slide">
      <div v-if="isMenuOpen" 
        ...
        <div class="px-6 space-y-6 text-center relative z-10">
          <NuxtLink v-for="link in navLinks" :key="link.path" :to="link.path" @click="closeMenu"
            class="block text-6xl font-amatic font-bold text-[#F2F2F2] hover:text-[#F2C46D] transition-colors">
            {{ link.name }}
          </NuxtLink>
          
          <div class="pt-8">
            <a href="https://wa.me/57XXXXXXXXXX"
              class="inline-block px-12 py-5 bg-[#F2C46D] text-[#1D5948] font-bold uppercase tracking-widest text-sm rounded-full shadow-2xl">
              WhatsApp Directo
            </a>
          </div>
        </div>
